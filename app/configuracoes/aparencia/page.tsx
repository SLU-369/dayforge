    ...
    <div className={styles.page}>
      ...
      <div className={styles.grid}>
        <section className={styles.card} aria-labelledby="theme-heading">
          ...
          <p className={styles.note}>No automático, o sol percorre o céu lentamente e o pôr do sol traz tons alaranjados. Os horários são calculados neste dispositivo; nenhuma localização é solicitada ou enviada.</p>
